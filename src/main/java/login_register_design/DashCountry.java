...
public class DashCountry extends javax.swing.JFrame {

    public String status_edit = "new";

    //metodo para inserção de novos registos no banco
    private boolean insert(String country) {
        PreparedStatement st;
        int ur;
        
        //verifica se o campo de texto é vazio
        if (!(country != null && !country.isEmpty())) {
            showMessageDialog(null, "País não pode ser vazia!");
            return false;
        }

        //faz a inserção no banco de dados
        try {
            String query = "INSERT INTO vinho_country(country) VALUES (?)";
            ...
            Logger.getLogger(DashCountry.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private boolean delete(int id) {
        ...
        try {
            String query = "DELETE FROM vinho_country WHERE ID = ?";
            st = My_CNX.getConnection().prepareStatement(query);
            st.setInt(1, id);
            ur = st.executeUpdate();
    ...
    //metodo para fazer o update de country por ID
    private boolean update(int id, String country) {
        PreparedStatement st;
        int ur;

        // valida o campo string country que nao pode ser vazio nem nulo
        if (!(country != null && !country.isEmpty())) {
            showMessageDialog(null, "País não pode ser vazia!");
            return false;
        }
        ...
        try {
            String query = "UPDATE vinho_country SET country = ? WHERE id = ?";
            st = My_CNX.getConnection().prepareStatement(query);
            st.setString(1, country);
            st.setInt(2, id);
            ur = st.executeUpdate();
    ...
    private void load_table(String where) {
        ...
        try {
            String query = "SELECT id, country FROM vinho_country WHERE country like ?";
            st = My_CNX.getConnection().prepareStatement(query);
            ...
            while (rs.next()) {
                ...
                r_id = rs.getInt("id");
                model.addRow(new Object[]{r_id, r_country});
            }
        ...
        jTable1.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
            ...
            public void valueChanged(ListSelectionEvent event) {
                ...
                if (jTable1.getSelectedRow() > -1) {
                    ...
                    //quando a linha é selecionada, ele seta os valores para o form (label ID e text field country)
                    int id_selecionado;
                    String country_selecionada;
                    id_selecionado = Integer.parseInt(jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString());
                    country_selecionada = jTable1.getValueAt(jTable1.getSelectedRow(), 1).toString();
                    jLabel_id.setText("" + id_selecionado);
                    jTextField_Brand.setText(country_selecionada);
    ...
    private void initComponents() {
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(bt_new)
                            .addComponent(jButton_opendashvinho))
                        .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
        );
        ...
        jLabel1.setText("Dashboard - País");
    ...
    private void bt_delActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_delActionPerformed
        ...
        int input = JOptionPane.showConfirmDialog(null, "Tem certeza que deseja deletar a country: " + jTextField_Brand.getText() + "?");
        if (input != 0) {
    ...
    private void bt_saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_saveActionPerformed
        ...
        if (status_edit.equals("new")) {
            ...
            //faz a atualização da country e atualização da tabela se sucesso
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DashCountry.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DashCountry().setVisible(true);
            }
        });
    }
