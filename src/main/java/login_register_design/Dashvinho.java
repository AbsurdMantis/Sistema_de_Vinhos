...
public class Dashvinho extends javax.swing.JFrame {
    ...
    private boolean insert(String vinho, int size, float alcohol, float price, int harvest, int brand, int country, int classe, int tpgrape, Blob image) {
        ...
        try {
            ...
            Logger.getLogger(Dashvinho.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        addTypeGrape = new javax.swing.JButton();
        ...
        bt_new.setText("Nova marca");
        bt_new.setActionCommand("Novo vinho");
        ...
        addTypeGrape.setText("+");
        addTypeGrape.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                addTypeGrapeMouseClicked(evt);
            }
        });
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(addMarca, javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(jSelection_marca, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 27, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(9, 9, 9)
                        .addComponent(jLabel10)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(addClass, javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(jSelection_class, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 27, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(9, 9, 9)
                        .addComponent(jLabel11)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(addCountry, javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(jSelection_Country, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 27, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(14, 14, 14)
                        .addComponent(jLabel13)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(addTypeGrape, javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(jSelection_typegrape, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 27, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void bt_cancActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_cancActionPerformed
        ...
        txt_nome.setEnabled(false);
        txt_preco.setEnabled(false);
        jSelection_class.setEnabled(false);
        jSelection_Country.setEnabled(false);
        jSelection_marca.setEnabled(false);
        jSelection_typegrape.setEnabled(false);
    ...
    private void bt_editActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_editActionPerformed
        ...
        status_edit = "edit";
        JTextField_vinhosearch.setText("");
        txt_alcool.setEnabled(true);
        txt_safra.setEnabled(true);
        txt_tamanho.setEnabled(true);
        txt_nome.setEnabled(true);
        txt_preco.setEnabled(true);
        jSelection_class.setEnabled(true);
        jSelection_Country.setEnabled(true);
        jSelection_marca.setEnabled(true);
        jSelection_typegrape.setEnabled(true);
    ...
    private void bt_delActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_delActionPerformed
        ...
        int input = JOptionPane.showConfirmDialog(null, "Tem certeza que deseja deletar o vinho: " + txt_nome.getText() + "?");
        if (input != 0) {
    ...
    private void bt_saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_saveActionPerformed
        ...
        jSelection_typegrape.setEnabled(false);
        JTextField_vinhosearch.setText("");
        ComboItem s_marca = (ComboItem) jSelection_marca.getSelectedItem();
        ComboItem s_Country = (ComboItem) jSelection_Country.getSelectedItem();
        ComboItem s_class = (ComboItem) jSelection_class.getSelectedItem();
        ComboItem s_typegrape = (ComboItem) jSelection_typegrape.getSelectedItem();
        ...
        if (status_edit.equals("new")) {
            ...
            if (insert(txt_nome.getText(),
                    Integer.parseInt(txt_tamanho.getText()),
                    Float.parseFloat(txt_alcool.getText()),
                    Float.parseFloat(txt_preco.getText()),
                    Integer.parseInt(txt_safra.getText()),
                    Integer.parseInt(s_marca.getValue()),
                    Integer.parseInt(s_Country.getValue()),
                    Integer.parseInt(s_class.getValue()),
                    Integer.parseInt(s_typegrape.getValue()), null
            )) {
                load_table(null);
            }
        } else {
            //faz a atualização da marca e atualização da tabela se sucesso
            if (update(Integer.parseInt(jLabel_id.getText()), txt_nome.getText(),
                    Integer.parseInt(txt_tamanho.getText()),
                    Float.parseFloat(txt_alcool.getText()),
                    Float.parseFloat(txt_preco.getText()),
                    Integer.parseInt(txt_safra.getText()),
    ...
    private void addCountryMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_addCountryMouseClicked
        DashCountry lf = new DashCountry();
        lf.setVisible(true);
        lf.pack();
        lf.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        this.dispose();
    ...
    private void addTypeGrapeMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_addTypeGrapeMouseClicked
        DashTypeGrape lf = new DashTypeGrape();
        lf.setVisible(true);
        lf.pack();
        lf.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        this.dispose();
    }//GEN-LAST:event_addTypeGrapeMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Dashvinho.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JButton addTypeGrape;
