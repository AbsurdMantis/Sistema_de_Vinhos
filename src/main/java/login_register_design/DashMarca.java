...
public class DashMarca extends javax.swing.JFrame {

    public String status_edit = "new";

    //metodo para inserção de novos registos no banco
    private boolean insert(String marca) {
        PreparedStatement st;
        int ur;
        
        //verifica se o campo de texto é vazio
        if (!(marca != null && !marca.isEmpty())) {
            showMessageDialog(null, "Marca não pode ser vazia!");
            return false;
        }

        //faz a inserção no banco de dados
        try {
            String query = "INSERT INTO vinho_brand(brand) VALUES (?)";
    ...
    private boolean delete(int id) {
        ...
        try {
            String query = "DELETE FROM vinho_brand WHERE ID = ?";
            st = My_CNX.getConnection().prepareStatement(query);
            st.setInt(1, id);
            ur = st.executeUpdate();
    ...
    private boolean update(int id, String marca) {
        PreparedStatement st;
        int ur;
        ...
        try {
            String query = "UPDATE vinho_brand SET brand = ? WHERE id = ?";
            st = My_CNX.getConnection().prepareStatement(query);
            st.setString(1, marca);
            st.setInt(2, id);
            ur = st.executeUpdate();
    ...
    private void load_table(String where) {
        ...
        try {
            String query = "SELECT id, brand FROM vinho_brand WHERE brand like ?";
            st = My_CNX.getConnection().prepareStatement(query);
            ...
            while (rs.next()) {
                r_marca = rs.getString("brand");
                r_id = rs.getInt("id");
                model.addRow(new Object[]{r_id, r_marca});
            }
        ...
        jTable1.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
            ...
            public void valueChanged(ListSelectionEvent event) {
                ...
                if (jTable1.getSelectedRow() > -1) {
                    ...
                    int id_selecionado;
                    String marca_selecionada;
                    id_selecionado = Integer.parseInt(jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString());
                    marca_selecionada = jTable1.getValueAt(jTable1.getSelectedRow(), 1).toString();
                    jLabel_id.setText("" + id_selecionado);
                    jTextField_Brand.setText(marca_selecionada);
    ...
    private void initComponents() {
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                ...
                                .addComponent(bt_new, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                        .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
        );
        ...
        jLabel1.setText("Dashboard - Marcas");
    ...
    private void bt_delActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_delActionPerformed
        ...
        int input = JOptionPane.showConfirmDialog(null, "Tem certeza que deseja deletar a marca: " + jTextField_Brand.getText() + "?");
        if (input != 0) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DashMarca.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
