...
public class DashTypeGrape extends javax.swing.JFrame {

    public String status_edit = "new";

    //metodo para inserção de novos registos no banco
    private boolean insert(String TypeGrape) {
        PreparedStatement st;
        int ur;
        
        //verifica se o campo de texto é vazio
        if (!(TypeGrape != null && !TypeGrape.isEmpty())) {
            showMessageDialog(null, "Tipo da Uva não pode ser vazia!");
            return false;
        }

        //faz a inserção no banco de dados
        try {
            String query = "INSERT INTO vinho_typegrape(typegrape) VALUES (?)";
            st = My_CNX.getConnection().prepareStatement(query);
            st.setString(1, TypeGrape);
            ur = st.executeUpdate();
            //retorna se a inserção inseriu linhas, ou não (caso erro ur valerá 0 ou -1 e retornará falso)
            return (ur > 0);
        } catch (SQLException ex) {
            Logger.getLogger(DashTypeGrape.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private boolean delete(int id) {
        ...
        try {
            String query = "DELETE FROM vinho_typegrape WHERE ID = ?";
            st = My_CNX.getConnection().prepareStatement(query);
            st.setInt(1, id);
            ur = st.executeUpdate();
    ...
    //metodo para fazer o update de TypeGrape por ID
    private boolean update(int id, String TypeGrape) {
        PreparedStatement st;
        int ur;

        // valida o campo string TypeGrape que nao pode ser vazio nem nulo
        if (!(TypeGrape != null && !TypeGrape.isEmpty())) {
            showMessageDialog(null, "Tipo da Uva não pode ser vazia!");
            return false;
        }
        ...
        try {
            String query = "UPDATE vinho_typegrape SET typegrape = ? WHERE id = ?";
            st = My_CNX.getConnection().prepareStatement(query);
            st.setString(1, TypeGrape);
            st.setInt(2, id);
            ur = st.executeUpdate();
    ...
    private void load_table(String where) {
        ...
        try {
            String query = "SELECT id, typegrape FROM vinho_typegrape WHERE typegrape like ?";
            st = My_CNX.getConnection().prepareStatement(query);
            ...
            while (rs.next()) {
                ...
                r_id = rs.getInt("id");
                model.addRow(new Object[]{r_id, r_TypeGrape});
            }
        ...
        jTable1.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
            ...
            public void valueChanged(ListSelectionEvent event) {
                ...
                if (jTable1.getSelectedRow() > -1) {
                    ...
                    //quando a linha é selecionada, ele seta os valores para o form (label ID e text field typegrape)
                    int id_selecionado;
                    String TypeGrape_selecionada;
                    id_selecionado = Integer.parseInt(jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString());
                    TypeGrape_selecionada = jTable1.getValueAt(jTable1.getSelectedRow(), 1).toString();
                    jLabel_id.setText("" + id_selecionado);
                    jTextField_Brand.setText(TypeGrape_selecionada);
    ...
    private void initComponents() {
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addComponent(JTextField_vinhosearch)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(jButton_opendashvinho, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(bt_new, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 89, Short.MAX_VALUE))
        ...
        jLabel1.setText("Dashboard - Tipo de Uva");
    ...
    private void bt_delActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_delActionPerformed
        ...
        int input = JOptionPane.showConfirmDialog(null, "Tem certeza que deseja deletar a TypeGrape: " + jTextField_Brand.getText() + "?");
        if (input != 0) {
    ...
    private void bt_saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_saveActionPerformed
        ...
        if (status_edit.equals("new")) {
            ...
            //faz a atualização da TypeGrape e atualização da tabela se sucesso
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DashTypeGrape.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DashTypeGrape().setVisible(true);
            }
        });
    }
